...
/* Joystick keys */
#define ENG_JOYSTICK_1             0
#define ENG_JOYSTICK_2             1
#define ENG_JOYSTICK_3             2
#define ENG_JOYSTICK_4             3
#define ENG_JOYSTICK_5             4
#define ENG_JOYSTICK_6             5
#define ENG_JOYSTICK_7             6
#define ENG_JOYSTICK_8             7
#define ENG_JOYSTICK_9             8
#define ENG_JOYSTICK_10            9
#define ENG_JOYSTICK_11            10
#define ENG_JOYSTICK_12            11
#define ENG_JOYSTICK_13            12
#define ENG_JOYSTICK_14            13
#define ENG_JOYSTICK_15            14
#define ENG_JOYSTICK_16            15
#define ENG_JOYSTICK_LAST          ENG_JOYSTICK_16

#define ENG_HAT_CENTERED           0
#define ENG_HAT_UP                 1
#define ENG_HAT_RIGHT              2
#define ENG_HAT_DOWN               4
#define ENG_HAT_LEFT               8
#define ENG_HAT_RIGHT_UP           (ENG_HAT_RIGHT | ENG_HAT_UP)
#define ENG_HAT_RIGHT_DOWN         (ENG_HAT_RIGHT | ENG_HAT_DOWN)
#define ENG_HAT_LEFT_UP            (ENG_HAT_LEFT  | ENG_HAT_UP)
#define ENG_HAT_LEFT_DOWN          (ENG_HAT_LEFT  | ENG_HAT_DOWN)

/* Gamepad Keys */
#define ENG_GAMEPAD_BUTTON_A               0
#define ENG_GAMEPAD_BUTTON_B               1
#define ENG_GAMEPAD_BUTTON_X               2
#define ENG_GAMEPAD_BUTTON_Y               3
#define ENG_GAMEPAD_BUTTON_LEFT_BUMPER     4
#define ENG_GAMEPAD_BUTTON_RIGHT_BUMPER    5
#define ENG_GAMEPAD_BUTTON_BACK            6
#define ENG_GAMEPAD_BUTTON_START           7
#define ENG_GAMEPAD_BUTTON_GUIDE           8
#define ENG_GAMEPAD_BUTTON_LEFT_THUMB      9
#define ENG_GAMEPAD_BUTTON_RIGHT_THUMB     10
#define ENG_GAMEPAD_BUTTON_DPAD_UP         11
#define ENG_GAMEPAD_BUTTON_DPAD_RIGHT      12
#define ENG_GAMEPAD_BUTTON_DPAD_DOWN       13
#define ENG_GAMEPAD_BUTTON_DPAD_LEFT       14
#define ENG_GAMEPAD_BUTTON_LAST            ENG_GAMEPAD_BUTTON_DPAD_LEFT

#define ENG_GAMEPAD_BUTTON_CROSS       ENG_GAMEPAD_BUTTON_A
#define ENG_GAMEPAD_BUTTON_CIRCLE      ENG_GAMEPAD_BUTTON_B
#define ENG_GAMEPAD_BUTTON_SQUARE      ENG_GAMEPAD_BUTTON_X
#define ENG_GAMEPAD_BUTTON_TRIANGLE    ENG_GAMEPAD_BUTTON_Y

#define ENG_GAMEPAD_AXIS_LEFT_X        0
#define ENG_GAMEPAD_AXIS_LEFT_Y        1
#define ENG_GAMEPAD_AXIS_RIGHT_X       2
#define ENG_GAMEPAD_AXIS_RIGHT_Y       3
#define ENG_GAMEPAD_AXIS_LEFT_TRIGGER  4
#define ENG_GAMEPAD_AXIS_RIGHT_TRIGGER 5
#define ENG_GAMEPAD_AXIS_LAST          ENG_GAMEPAD_AXIS_RIGHT_TRIGGER
